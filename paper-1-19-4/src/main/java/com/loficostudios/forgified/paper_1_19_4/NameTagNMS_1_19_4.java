...
import com.loficostudios.forgified.paper.nametags.BukkitTarget;
import com.loficostudios.forgified.paper.nametags.NameTagNMS;
import com.loficostudios.forgified.paper.nametags.NametagEntity;
...
public class NameTagNMS_1_19_4 implements NameTagNMS {
    ...
    private List<EntityData<?>> getEntityData(NametagEntity entity) {
         return List.of(
                ...
                new EntityData<>(23, EntityDataTypes.ADV_COMPONENT, Component.join(JoinConfiguration.separator(Component.newline()), entity.getNameTag().getLines()))
        );
    }
